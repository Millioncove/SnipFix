...
### Old ffmpeg version...
Currently, SnipFix uses the 0.10.1 version of ffmpeg.wasm. This version lacks some features and contains some bugs that needed workarounds. Most notably another javascript library ([crunker](https://github.com/jaggad/crunker)) had to be used to merge audio files.
